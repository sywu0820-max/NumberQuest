...
test('successor shell does not regress to an older app entrypoint',()=>{
  assert.match(html,/v08-app\.js/);assert.doesNotMatch(html,/src="v04-app\.js"/);assert.doesNotMatch(html,/src="v05-app\.js"/);assert.doesNotMatch(html,/src="v06-app\.js"/);assert.doesNotMatch(html,/src="v07-app\.js"/);
});
